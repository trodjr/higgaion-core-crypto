...
- `verification/coq/PQCMigration.v` — especially the 4-state FSM invariants, `PQC_ONLY_irreversible`, disjunctive OR-mode safety, and adversarial crash recovery with Erasure-Before-WAL
